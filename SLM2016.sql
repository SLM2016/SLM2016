...
CREATE TABLE `course_has_cc_address` (
  ...
  CONSTRAINT `FK_course_cc_address_course_info` FOREIGN KEY (`fk_course_id`) REFERENCES `course_info` (`id`)
...
CREATE TABLE `course_has_date` (
  ...
  CONSTRAINT `FK_course_has_date_course_info` FOREIGN KEY (`fk_course_id`) REFERENCES `course_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course_has_ticket` (
  ...
  CONSTRAINT `FK_course_ticket_info_course_info` FOREIGN KEY (`fk_course_id`) REFERENCES `course_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course_info` (
  ...
  CONSTRAINT `FK_course_info_course_status` FOREIGN KEY (`fk_status_id`) REFERENCES `course_status` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
